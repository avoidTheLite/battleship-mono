...
function parseRecordData<T>(data: string | T): T {
...
function parseLastAttack(lastAttack: string | AttackResult | null): AttackResult {
    ...
    return parseRecordData<AttackResult>(lastAttack);
}
...
function convertPlayerRecordToPlayer(playerRecord: PlayerRecord): Player {
    return {
        ...
        board_data: parseRecordData<Board>(playerRecord.board_data),
        attack_data: parseRecordData<Board>(playerRecord.attack_data),
        ship_data: parseRecordData<ShipData>(playerRecord.ship_data),
