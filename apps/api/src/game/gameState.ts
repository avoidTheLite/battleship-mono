    ...
    public async getGame(gameID: string): Promise<GameState> {
        ...
        .then((playerRecords: PlayerRecord[]) => {
            ...
            const players = [{
                ...
                last_attack: parseJsonField(playerRecords[0].last_attack, createEmptyAttackResult())
            },{
                ...
                last_attack: parseJsonField(playerRecords[1].last_attack, createEmptyAttackResult())
            }];
            return players;
        });
        const gameState = {
